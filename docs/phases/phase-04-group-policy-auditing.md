...
![GPO link and scope](../../screenshots/phase-04/gpo.png)
...
![Audit Logon policy](../../screenshots/phase-04/audit%20logon.png)
...
![Audit User Account Management policy](../../screenshots/phase-04/audit%20user%20account%20management.png)
...
*Event 4625 records a failed logon attempt for `VERMACORP\karan.admin` on CLIENT01.*
